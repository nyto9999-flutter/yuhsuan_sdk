...
class DateFormats {
  ...
  static String zh_full = 'yyyy年MM月dd日 HH時mm分ss秒';
  static String zh_y_mo_d_h_m = 'yyyy年MM月dd日 HH時mm分';
  ...
  static String zh_h_m_s = 'HH時mm分ss秒';
  static String zh_h_m = 'HH時mm分';
}
...
class DateUtil {
  ...
  String getWeekday(DateTime? dateTime,
    ...
    switch (dateTime.weekday) {
      case 1:
        weekday = languageCode == 'en' ? '星期一' : 'Monday';
        break;
      case 2:
        weekday = languageCode == 'en' ? '星期二' : 'Tuesday';
        break;
      case 3:
        weekday = languageCode == 'en' ? '星期三' : 'Wednesday';
        break;
      case 4:
        weekday = languageCode == 'en' ? '星期四' : 'Thursday';
        break;
      case 5:
        weekday = languageCode == 'en' ? '星期五' : 'Friday';
        break;
      case 6:
        weekday = languageCode == 'en' ? '星期六' : 'Saturday';
        break;
      case 7:
        weekday = languageCode == 'en' ? '星期日' : 'Sunday';
        break;
      default:
        break;
    }
